    ...
    <el-table
      ...
      <el-table-column label="操作" width="180" align="center" fixed="right">
        <template slot-scope="scope">
          ...
          <el-button type="danger" icon="el-icon-delete" size="mini" @click="removeDataById(scope.row.id)" title="删除" :disabled="$hasBP('bnt.sysMenu.remove')  === false || scope.row.children.length > 0"/>
        </template>
      </el-table-column>
    </el-table>
