...
![image-20240103152513882](RabbitMQ_02.assets/image-20240103152513882.png)
...
![img](RabbitMQ_02.assets/17042703580265.png)
...
![img](RabbitMQ_02.assets/17042703580251.png)
...
![img](RabbitMQ_02.assets/17042703580252.png)
...
![img](RabbitMQ_02.assets/17042703580253.png)
...
![img](RabbitMQ_02.assets/17042703580264.png)
...
![img](RabbitMQ_02.assets/170427445607916.png)
...
![img](RabbitMQ_02.assets/170427445608017.png)
...
![img](RabbitMQ_02.assets/170427445608018.png)
...
![img](RabbitMQ_02.assets/170427445608019.png)
...
![img](RabbitMQ_02.assets/170427445608120.png)
...
![img](RabbitMQ_02.assets/170427445608121.png)
...
![img](RabbitMQ_02.assets/170427974874134.png)

放行以后，由于抛出的是**消息转换异常**，因此Spring会自动返回`reject`，所以消息依然会被删除：

![img](RabbitMQ_02.assets/170427974874135.png)
...
![img](RabbitMQ_02.assets/170427974874236.png)

放行以后，由于抛出的是业务异常，所以Spring返回`ack`，最终消息恢复至`Ready`状态，并且没有被RabbitMQ删除：

![img](RabbitMQ_02.assets/170427974874237.png)
...
![img](RabbitMQ_02.assets/170427977117146.png)
...
查看`error.queue`队列中的消息，还包含了异常信息：

![Snipaste_2024-01-03_17-31-18](RabbitMQ_02.assets/Snipaste_2024-01-03_17-31-18.png)
...
![image-20240103180511612](RabbitMQ_02.assets/image-20240103180511612.png)
...
![img](RabbitMQ_02.assets/170436968949454.png)
...
![img](RabbitMQ_02.assets/170436972771065.png)

当然，也可以直接使用课前资料提供好的插件：

![img](RabbitMQ_02.assets/170436972771066.png)
...
![img](RabbitMQ_02.assets/170436972771167.png)
...
![img](RabbitMQ_02.assets/170444765531674.jpeg)
...
![img](RabbitMQ_02.assets/170444765531775.jpeg)

由于我们要多次发送延迟消息，因此需要先定义一个记录消息延迟时间的消息体，处于通用性考虑，我们将其定义到`hm-common`模块下：

![img](RabbitMQ_02.assets/170444765531776.png)
...
![img](RabbitMQ_02.assets/170444768647683.png)
...
![img](RabbitMQ_02.assets/170444768647684.png)
...
![img](RabbitMQ_02.assets/170444768647785.png)
...
![img](RabbitMQ_02.assets/170444771824992.png)
...
![img](RabbitMQ_02.assets/170444773733095.png)
